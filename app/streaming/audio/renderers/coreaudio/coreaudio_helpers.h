...
// These helpers only feed DEBUG_TRACE, which compiles away in release builds
#define CA_DEBUG_HELPER __attribute__((unused))
...
CA_DEBUG_HELPER static void CA_PrintASBD(const char *description, const AudioStreamBasicDescription *asbd)
{
    char formatIDStr[5];
